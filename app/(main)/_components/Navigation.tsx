    ...
    <>
      ...
      >
        <div
          ...
          role="button"
          className={cn(
            "h-6 w-6 text-muted-foreground rounded-sm absolute top-3 right-2 opacity-0 hover:bg-neutral-300 dark:bg-neutral-600 group-hover/sidebar:opacity-100 transition",
